      ...
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          <p>
            ...
            STREETFEAST MOBILE APPLICATION OR WEBSITE. THESE TERMS CONTAIN AN ARBITRATION
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            and any additional terms, policies, or guidelines referenced herein, all of which
            are incorporated by reference into these Terms. If you do not agree to these Terms,
            you must immediately cease all use of the Service.
          </p>
          <p>
            These Terms constitute a legally binding agreement between you (&quot;you,&quot; &quot;your,&quot;
            or &quot;User&quot;) and StreetFeast (&quot;StreetFeast,&quot; &quot;Company,&quot;
            &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). We reserve the right to modify these
            Terms at any time at our sole discretion. Material changes will be communicated
            through the App, by email, or by posting updated Terms on the Site with a revised
            &quot;Last Updated&quot; date. Your continued use of the Service following such
            modifications constitutes your acceptance of the revised Terms. It is your
            responsibility to review these Terms periodically. If you do not agree to any
            modifications, your sole remedy is to discontinue use of the Service.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            If you are using the Service on behalf of a business entity (including, without
            limitation, a food truck, vendor, or restaurant), you represent and warrant that
            you have the legal authority to bind that entity to these Terms. In such case,
            &quot;you&quot; and &quot;your&quot; shall refer to such entity.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            <strong>4.5 Account Suspension and Termination.</strong> We reserve the right, in
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            modify subscription pricing at any time; provided, however, that any price changes
          ...
          <p>
            ...
            eligibility is determined by StreetFeast and the applicable App Store or payment
          ...
          <p>
            ...
            subscription pricing at any time. If we change the pricing for your subscription,
            we will provide you with reasonable advance notice of such change. Your continued
            use of the Vendor Subscription after the price change takes effect constitutes your
            agreement to pay the modified subscription amount.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            <strong>6.1 StreetFeast Intellectual Property.</strong> The Service, including all
            text, graphics, photographs, images, illustrations, icons, software, source code,
            object code, data, databases, interfaces, trademarks, service marks, trade names,
            logos, trade dress, domain names, slogans, documentation, audio, video, and other
            ...
            the property of StreetFeast or its licensors and are protected by United States and
            international copyright, trademark, patent, trade secret, and other intellectual
            property or proprietary rights laws. No license, right, title, or interest in or to
            any StreetFeast Content is granted to you except as expressly set forth herein. All
            rights not expressly granted are reserved by StreetFeast.
          </p>
          <p>
            ...
            (a) modify, reproduce, distribute, or create derivative works of the Service or
            StreetFeast Content; (b) use any data mining, robots, scraping, or similar data
        ...
        <section className={styles.section}>
          ...
          <p>
            <strong>7.2 License Grant.</strong> By submitting, posting, or uploading User Content
            to or through the Service, you hereby grant to StreetFeast a worldwide, non-exclusive,
          ...
          <p>
            ...
            marketing and promotional activities. Vendors represent and warrant that all Vendor
            content is accurate, current, not misleading, and complies with all applicable laws
            and regulations, including without limitation food labeling and allergen disclosure
            requirements.
          </p>
          <p>
          ...
          <p>
            ...
            any time, in its sole discretion, with or without notice, for any reason or no reason.
            Without limiting the foregoing, StreetFeast may remove or disable access to any User
            Content that StreetFeast, in its sole discretion, considers to be in violation of
            these Terms, applicable law, or otherwise objectionable. StreetFeast shall not be
            liable for any removal or failure to remove User Content.
          </p>
          <p>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            Media does not infringe or violate any third-party rights, including intellectual
            property rights, privacy rights, or publicity rights; (c) if the Media depicts any
            identifiable individual, you have obtained the express consent of such individual
            to use their likeness in connection with the Service; and (d) the Media does not
            contain any illegal, harmful, threatening, abusive, hateful, defamatory, or otherwise
        ...
        <section className={styles.section}>
          ...
          <p>
            If you believe that any content on the Service infringes your copyright, you may
            submit a DMCA Takedown Notice containing the following information:
          </p>
          <ul>
            <li>
          ...
          <p>
            ...
            You acknowledge that for StreetFeast to act on your notice, it must comply with all
            of the requirements of this Section. StreetFeast reserves the right to terminate the
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>
              ...
              Service for any purpose without StreetFeast&apos;s express written permission;
            </li>
            <li>
              Interfere with or disrupt the Service, servers, or networks connected to the Service,
              including through the transmission of viruses, worms, malware, or other harmful code;
            </li>
            <li>
            ...
            <li>
              ...
              through artificial or fraudulent means; or
            </li>
            <li>
        ...
        <section className={styles.section}>
          ...
          <p>
            <strong>11.1 Privacy Policy.</strong> Your use of the Service is governed by our
          ...
          <ul>
            ...
            <li>
              ...
              (including PostHog and Sentry) to collect information about how you interact with
              the Service, including pages visited, features used, tap events, session duration,
              and error reports. Error tracking services may collect device state information and
              session replay data in connection with app errors;
            </li>
            <li>
          ...
          <p>
            ...
            acknowledge and consent to the transfer, storage, and processing of your personal
            data in the United States and other jurisdictions that may not provide the same level
            of data protection as your jurisdiction of residence. By using the Service, you
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            notifications to Users who have favorited their truck. Such notifications are subject
            to rate limitations imposed by StreetFeast. StreetFeast is not responsible for the
            content of Vendor-initiated notifications and does not endorse or guarantee any
        ...
        <section className={styles.section}>
          ...
          <p>
            YOU ACKNOWLEDGE THAT STREETFEAST IS A TECHNOLOGY PLATFORM AND NOT A FOOD SERVICE
            PROVIDER, HEALTH INSPECTOR, OR REGULATORY BODY. ANY RELIANCE ON VENDOR INFORMATION,
            USER CONTENT, OR ANY OTHER CONTENT AVAILABLE THROUGH THE SERVICE IS AT YOUR SOLE
            RISK. STREETFEAST DOES NOT GUARANTEE THAT VENDORS COMPLY WITH APPLICABLE HEALTH,
            SAFETY, FOOD HANDLING, ALLERGEN DISCLOSURE, OR LICENSING REQUIREMENTS.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>Any errors, inaccuracies, or omissions in Vendor information, location data,
              or other content;</li>
            <li>Any interruption, suspension, or termination of the Service; or</li>
            <li>Any other matter relating to the Service,</li>
          </ul>
          <p>
            WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), STRICT LIABILITY,
            PRODUCT LIABILITY, OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT STREETFEAST HAS
            BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES, AND EVEN IF A LIMITED REMEDY SET
          ...
          <p>
            ...
            OR THE SERVICE SHALL NOT EXCEED THE GREATER OF: (A) ONE HUNDRED UNITED STATES DOLLARS
            (US $100.00); OR (B) THE TOTAL AMOUNT YOU PAID TO STREETFEAST IN SUBSCRIPTION FEES
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            penalties, expenses, and costs (including reasonable attorneys&apos; fees and court
            costs) arising out of or in connection with: (a) your access to or use of the
            Service; (b) your User Content or any other content you submit, post, or transmit
            through the Service; (c) your violation of these Terms; (d) your violation of any
            applicable law, rule, regulation, or the rights of any third party; (e) any dispute
            between you and any Vendor or other User; (f) your negligence, willful misconduct,
            or fraud; or (g) any misrepresentation made by you.
          </p>
          <p>
            StreetFeast reserves the right, at your expense, to assume the exclusive defense and
            control of any matter subject to indemnification by you, in which case you agree to
            cooperate fully with StreetFeast in the defense of such matter. You shall not settle
            any claim subject to indemnification without StreetFeast&apos;s prior written consent.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            any Dispute, including the scope, applicability, validity, and enforceability of this
        ...
        <section className={styles.section}>
          ...
          <p>
            The Service may be subject to U.S. export control laws and regulations. You shall
            not, directly or indirectly, export, re-export, or transfer the Service or any
            portion thereof to any country, entity, or person prohibited by applicable export
            control laws, including without limitation: (a) any country subject to a U.S.
            Government embargo; (b) any person or entity on the U.S. Department of the
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            constitute the sole and entire agreement between you and StreetFeast with respect to
            the subject matter hereof and supersede all prior and contemporaneous understandings,
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            report a complaint to the Complaint Assistance Unit of the Division of Consumer
            Services of the California Department of Consumer Affairs by telephone at
            (800) 952-5210 or by mail at 400 R Street, Sacramento, CA 95814.
          </p>
        </section>
      </main>
    </div>
